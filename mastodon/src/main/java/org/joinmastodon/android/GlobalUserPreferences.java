...
public class GlobalUserPreferences{
	...
	public static boolean enableNewHomeLayout;
	...
	public static void load(){
		...
		enableNewHomeLayout=prefs.getBoolean("enableNewHomeLayout", true);
	...
	public static void save(){
		getPrefs().edit()
				...
				.putBoolean("enableNewHomeLayout", enableNewHomeLayout)
